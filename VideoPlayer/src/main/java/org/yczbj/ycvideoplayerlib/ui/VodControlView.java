...
public class VodControlView extends FrameLayout implements IControlComponent,
    ...
    public void setProgress(int duration, int position) {
        ...
        if (mTotalTime != null)
            mTotalTime.setText(PlayerUtils.formatTime(duration));
        if (mCurrTime != null)
            mCurrTime.setText(PlayerUtils.formatTime(position));
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (mCurrTime != null)
            mCurrTime.setText(PlayerUtils.formatTime(newPosition));
    }
}
